...
module "rcg-azure-prod-westeurope" {
  ...
  ipgroup_azure_prod_westeurope_id = module.ip_groups.ipgroup-azure-prod-westeurope_id
}
...
module "rcg-workload1-dev-westeurope" {
  ...
  firewall_policy_id                  = module.afwp-networking-prod-westeurope.id
  ipgroup_onprem_prod_westeurope_id   = module.ip_groups.ipgroup-onprem-prod-westeurope_id
  ipgroup_azure_prod_westeurope_id    = module.ip_groups.ipgroup-azure-prod-westeurope_id
  ipgroup_workload1_dev_westeurope_id = module.ip_groups.ipgroup-workload1-dev-westeurope_id
}
...
module "rcg-workload2-prod-westeurope" {
  ...
  firewall_policy_id                   = module.afwp-networking-prod-westeurope.id
  ipgroup_workload3_prod_westeurope_id = module.ip_groups.ipgroup-workload3-prod-westeurope_id
}
